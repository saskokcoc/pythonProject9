<? xml версія = " 1.0 " ?>
<!--
Фронтальний детектор обличчя котів, що використовує повний набір функцій Haar, тобто
горизонтальні, вертикальні та діагональні елементи.
Надав Джозеф Хоуз (josephhowse@nummist.com).
Більш детальну інформацію можна знайти в наступних публікаціях і
презентації:
Джозеф Хаус. OpenCV для секретних агентів (книга). Packt Publishing, січ
   2015 рік.
Джозеф Хаус. «Навчання детекторів і розпізнавачів у Python і OpenCV»
   (підручник). ISMAR 2014. 9 вересня 2014 р.
   http://nummist.com/opencv/Howse_ISMAR_20140909.pdf
Джозеф Хаус. «Навчання інтелектуальних систем камери за допомогою Python і OpenCV»
   (веб-трансляція). O'Reilly Media. 17 червня 2014 року.
   http://www.oreilly.com/pub/e/3077
Сценарії збірки та демонстраційні програми можна знайти в такому репозиторії:
https://bitbucket.org/Joe_Howse/angora-blue
ВІДОМІ ОБМЕЖЕННЯ:
Передбачається вертикальний предмет. У ситуаціях, коли може бути морда кота
набік або вниз головою (наприклад, кіт перевертається), спробуйте різні оберти
вхідного зображення.
ЖУРНАЛ ЗМІН:
2016-08-06: Повторне навчання з більшою кількістю негативних зразків і більшою кількістю етапів. помилковий
   позитиви зараз набагато рідше. Якщо ви адаптували свій код для каскаду
   попередньої версії, тепер вам слід повторно налаштувати аргументи
   CascadeClassifier::detectMultiScale. Наприклад, зменшити значення
   Аргумент minNeighbors. Для цього не потрібно використовувати детектор людського обличчя
   більше не перевіряйте позитиви.
2014-04-25: Перший випуск (на https://bitbucket.org/Joe_Howse/angora-blue)
////////////////////////////////////////////////// //////////////////////////
| Ліцензійна угода учасників
| ВАЖЛИВО: ПРОЧИТАЙТЕ ПЕРЕД ЗАВАНТАЖЕННЯМ, КОПІЮВАННЯМ, ВСТАНОВЛЕННЯМ АБО ВИКОРИСТАННЯМ.
| Завантажуючи, копіюючи, встановлюючи або використовуючи програмне забезпечення, ви погоджуєтесь
| до цієї ліцензії.
| Якщо ви не згодні з цією ліцензією, не завантажуйте, не встановлюйте,
| копіювати або використовувати програмне забезпечення.
|
| Авторське право (c) 2014-2016, Джозеф Хоуз (Nummist Media Corporation Limited,
| Галіфакс, Нова Шотландія, Канада). Всі права захищені.
|
| Перерозподіл і використання у вихідній і двійковій формах, з або без
| модифікації, дозволені за умови дотримання наступних умов
| зустрів:
|
| * Повторне розповсюдження вихідного коду має зберігати зазначені вище авторські права
| зауважте, цей список умов і наступне застереження.
| * Перерозподіл у двійковій формі має відтворювати наведене вище
| повідомлення про авторські права, цей список умов і наступне
| застереження в документації та/або інших наданих матеріалах
| з розподілом.
| * Ім’я учасника не можна використовувати для підтримки чи просування продуктів
| отримані з цього програмного забезпечення без спеціального попереднього письмового дозволу.
|
| ЦЕ ПРОГРАМНЕ ЗАБЕЗПЕЧЕННЯ НАДАЄТЬСЯ ВЛАСНИКАМИ АВТОРСЬКИХ ПРАВ ТА УЧАСНИКАМИ
| "ЯК Є" ТА БУДЬ-ЯКІ ПРЯМІ АБО НЕПРЯМІ ГАРАНТІЇ, ВКЛЮЧАЮЧИ, АЛЕ НЕ
| ОБМЕЖУЮЧИСЯ НЕПРЯМИМИ ГАРАНТІЯМИ ПРИДАТНОСТІ ДЛЯ ПРОДАЖУ ТА ПРИДАТНОСТІ ДЛЯ
| КОНКРЕТНА МЕТА ВІДМОВЛЯЄТЬСЯ. У ЖОДНОМУ РАЗІ
| УЧАСНИКИ НЕСУТЬ ВІДПОВІДАЛЬНІСТЬ ЗА БУДЬ-ЯКІ ПРЯМІ, НЕПРЯМІ, ВИПАДКОВІ, СПЕЦІАЛЬНІ,
| ПРИКЛАДНІ АБО НЕПРЯМІ ЗБИТКИ (ВКЛЮЧАЮЧИ, АЛЕ НЕ ОБМЕЖУЮЧИСЬ,
| ЗАКУПІВЛЯ ЗАМІННИХ ТОВАРІВ АБО ПОСЛУГ; ВТРАТА КОРИСТУВАННЯ, ДАНИХ АБО
| ПРИБУТОК; АБО ПЕРЕРВА В РОБОТАХ) НЕЗАЛЕЖНО від причин, ТА ЗА БУДЬ-ЯКОЮ ТЕОРІЄЮ
| ВІДПОВІДАЛЬНІСТЬ ЗА ДОГОВОРОМ, СУВОРОЮ ВІДПОВІДАЛЬНІСТЮ АБО ДЕКІЛІНТОМ (ЗОКРЕМА
| НЕДБАЖНІСТЬ АБО ІНШИМ СПОСОБОМ, ЩО ВИНИКАЮТЬ В ВИКОРИСТАННІ ЦЬОГО
| ПРОГРАМНЕ ЗАБЕЗПЕЧЕННЯ, НАВІТЬ ЯКЩО БУЛО ПОВІДОМЛЕНО ПРО МОЖЛИВІСТЬ ТАКОГО ПОШКОДЖЕННЯ. Повертатися до
| Топ
////////////////////////////////////////////////// //////////////////////////
 -->
< opencv_storage >
